      ...
      <div className="max-w-[1340px] mx-auto px-[clamp(20px,4vw,60px)] relative z-10">
        ...
        <div className="mt-20 pt-14 border-t border-white/[0.08]">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-8">
            <p className="font-body text-[11px] tracking-[0.2em] uppercase text-white/40 font-medium">
            ...
            <a
              ...
              className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-white/20 hover:border-white/60 bg-white/[0.04] hover:bg-white/[0.1] text-[#F1F1EB] text-[12px] font-medium tracking-wider uppercase transition-all duration-300 w-fit group"
            >
              <svg
                className="w-3.5 h-3.5 text-[#8B2020] transition-transform duration-300 group-hover:translate-y-0.5"
                fill="none"
                stroke="currentColor"
                viewBox="0 0 24 24"
              >
